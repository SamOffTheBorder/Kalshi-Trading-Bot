...
from kalshi_bot.backtest.walkforward import rolling_folds, run_walkforward
...
def test_trade_economics_uses_trade_specific_prices():
    economics = trade_economics(
        entry_price_dollars=0.40, stop_price_dollars=0.30,
        target_price_dollars=0.60, quantity=10, modeled_win_probability=0.60,
    )
